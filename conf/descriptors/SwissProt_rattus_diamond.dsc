...
tasks.global.post=formatdb(lclid\=false;check\=true;nr\=true;taxinc\=10114),script(name=GetUP;path=get_up_release),script(name=DiamondIndex;path=run_diamond),delgz,deltmpidx
