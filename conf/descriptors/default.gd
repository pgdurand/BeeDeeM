...
# An example illustrating the installation of:
#  - a FASTA only bank: PDB proteins
#  - an annotated protein bank: Swissprot
#  - an annotated nucleotide bank: Virus subdivision of Refseq
db.list=PDB_proteins,Uniprot_SwissProt,Refseq_Viruses
...
#dumped in the log file of the software.
