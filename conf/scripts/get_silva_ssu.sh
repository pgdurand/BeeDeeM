...
# Silva SSURef Fasta file using HTTP protocol.
#
# This script is used in bank descriptor:
#   ../descriptors/Silva_SSU.dsc
#
...
filename="SILVA_138.1_SSURef_tax_silva.fasta.gz"
