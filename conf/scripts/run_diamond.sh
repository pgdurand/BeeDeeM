...
MY_SCRIPT="$script_dir/run_diamond.pbs -d $INST_DIR -n $BANK_NAME "
echo "Submitting ${MY_SCRIPT}..."
ANSWER=$(submitEx "omp" "64g" "8" "04:00:00" "dmnd-$BANK_NAME" "$WK_DIR" "-- ${MY_SCRIPT}")
RET_CODE=$?
