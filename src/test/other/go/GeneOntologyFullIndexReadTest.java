 ...
 * Gene Ontology databank.
 * 
 * @author Patrick G. Durand
 */
public class GeneOntologyFullIndexReadTest {

  /**
   * @param args
   *          command-line arguments. Two are expected: [0] is the lucene index
   *          and [1] is the GO plain text databank file.
   */
  public static void main(String[] args) {
    DBMSAbstractConfig.configureLog4J("GeneOntologyFullIndexReadTest");
    ...
    GeneOntologyOBONodeParser spp = new GeneOntologyOBONodeParser();
